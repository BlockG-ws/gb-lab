export const siteConfig = {
    ...
    comments: {
        ...
        artalk: {
            ...
            site: 'lab@GB', // the site name of the current site in artalk dashboard, default is "default"
        },
        giscus: {
    ...
    customFooter: '<p>给岁月以文明，给时光以生命。</p> <a href="https://icp.gov.moe/?keyword=20220007" target="_blank">萌ICP备20220007号</a>',
    ...
    siteAnalytics: {
        ...
        umami: {
            ...
            instanceDomain: 'umami.grassblock.eu.org',
            // the id of your website in umami, get it from your umami dashboard
            websiteId: 'cd3f2502-70ea-411a-9e87-c96f0d46a788',
            // also use pixels.
